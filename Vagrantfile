...
Vagrant.configure(2) do |config|
  ...
  # boxes will only be checked for updates when the user s
  ...
  # Configure all the necessary dependencies for CellProfiler and CellProfiler Analyst
  config.vm.provision "shell", inline: <<-SHELL
    sudo apt-get update
    sudo apt-get install git

    # Following Logans Tutorial
